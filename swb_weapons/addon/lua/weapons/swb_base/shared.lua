...
if CLIENT then
	...
	SWEP.RVBYawMod = 1
	SWEP.RVBRollMod = 1
	-- SWEP.BulletDisplay = 0 -- означало кол-во пуль, которые отображались на HUD. Зависело от режима стрельбы
...
SWEP.SWBWeapon = true
SWEP.Author       = "Spy"
SWEP.Contact      = "amd@default.im"
SWEP.Purpose      = ""
SWEP.Instructions = ""
SWEP.Category     = "TG Weapons"
...
function SWEP:ToggleSuppressor()
	...
	self.dt.Suppressed = not self.dt.Suppressed
end
